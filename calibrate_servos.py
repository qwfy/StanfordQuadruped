...
def calibrate_angle_offset(hardware_interface):
  ...
  k = float(
    input(
      "Enter the scaling constant for your servo. This constant is how much you have to increase the pwm pulse width (in microseconds) to rotate the servo output 1 degree. (It is 11.333 for the newer CLS6336 and CLS6327 servos). Input: ")
    )
  ...
  for leg_index in range(4):
    for axis in range(3):
      ...
      while not completed:
        ...
        okay = ""
        prompt = "The leg should be at exactly **" + ["horizontal", "45 degrees", "45 degrees"][
          axis] + "**. Are you satisfied? Enter 'yes' or 'no': "
...
def main():
  ...
  print(
    "Set the MICROS_PER_RAD value in pupper/HardwareConfig.py to whatever you defined in the beginning of this program as well.")
